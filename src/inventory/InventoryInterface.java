...
public interface InventoryInterface extends Remote {
   ...
   * 
   * @param productID - Produto a ser adicionado
   * @param qtd       - Quantidade a ser adicionada
   * @return Entrada do estoque recém cadastrada
   */
  public InventoryEntryInterface addNewProduct(String productName, String productDescription, float productPrice,
      int qtd) throws RemoteException;
   ...
   * @return Entrada do estoque recém modificada
   */
  public InventoryEntryInterface removeProductQtd(int productID, int qtd)
   ...
   * 
   * @param productID - Código de identificação do produto
   * @return Entrada do estoque, caso haja um item com o código correspondente ou
   *         {@code null}
   */
   ...
   * @return Entrada do estoque recém modificada
   */
  public InventoryEntryInterface editProduct(int productID, String productName, String productDescription,
      float productPrice) throws RemoteException, IllegalArgumentException;
}